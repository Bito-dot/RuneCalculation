...
const gameData = {
    ...
    "Realm 4": {
        "Starlight": [
            { name: "Moonlight", maxLevel: 650, baseOdds: 1.01, type: "Normal", maxStats: { stars: "x5", moon: "x6", oof: "x294" } },
            { name: "Sunlight", maxLevel: 500, baseOdds: "500De", type: "Normal", maxStats: { moon: "x7.5", planets: "x7", oof: "x126" } },
            { name: "Invasion", maxLevel: 450, baseOdds: "80DDe", type: "Normal", maxStats: { stars: "x25.5", planets: "x5", runeLuck: "x1.25", oof: "x91" } },
            { name: "Alien", maxLevel: 400, baseOdds: "225QdDe", type: "Normal", maxStats: { stars: "x15", planets: "x5.5", moon: "x7", oof: "x81" } },
            { name: "Universe", maxLevel: 375, baseOdds: "925SpDe", type: "Normal", maxStats: { stars: "x21", planets: "x3.25", moon: "x7", oof: "x151" } },
            { name: "Gravity", maxLevel: 350, baseOdds: "15UVt", type: "Normal", maxStats: { stars: "x16", blackholes: "x30", moon: "x11.5", oof: "x88.5", runeLuck: "x1.35" } },
            { name: "Dimensional", maxLevel: 325, baseOdds: "1QnVt", type: "Normal", maxStats: { moon: "x7", blackholes: "x4", planets: "x4", oof: "x49.7", tierLuck: "x5.5" } },
            { name: "Meteor", maxLevel: 300, baseOdds: "75UTg", type: "Normal", maxStats: { stars: "x91", oof: "x46", tierBulk: "x2.5", alienCash: "x8", blackholes: "x4", runeLuck: "x3" } },
            { name: "Nebula", maxLevel: 275, baseOdds: "2DTg", type: "Normal", maxStats: { stars: "x28.5", tierLuck: "x7", runeBulk: "x1.5", runeLuck: "x1.75", alienCash: "x46", oof: "x28.5" } },
            { name: "Supernova", maxLevel: 525, baseOdds: "200DVt", type: "Noobinial", maxStats: { alienXP: "x12.5", runeSpeed: "x4", oof: "x1.58k", planets: "x61", runeBulk: "x1.5", prism: "x1.05", alienCash: "x25", tierLuck: "x27.3" } },
            { name: "Galactic Chaos", maxLevel: 500, baseOdds: "2.25TVt", type: "Noobinial", maxStats: { prism: "x1.1", blackholes: "x1k", oof: "x2.5k", runeBulk: "x3", runeLuck: "x2", alienXP: "x10", knowledge: "x101", tierLuck: "x51" } },
            { name: "Chaotic Destruction", maxLevel: 200, baseOdds: "15QnVt", type: "Noobinial", maxStats: { stars: "x100k", oof: "x2k", runeBulk: "x2", runeLuck: "x25", chips: "x10", alienXP: "x500", planets: "x3k", tierLuck: "x31" } }
        ],
        "Cosma": [
            { name: "Asteroid", maxLevel: "370+", baseOdds: 1.01, type: "Normal", maxStats: { oof: "x5.7", stars: "x21", alienCash: "x2" } },
            { name: "Comet", maxLevel: "490+", baseOdds: "150UDe", type: "Normal", maxStats: { planets: "x5", spacePoints: "x3", knowledge: "x4", runeLuck: "x2.5", oof: "x13.7" } },
            { name: "Satellite", maxLevel: 650, baseOdds: "3QdDe", type: "Normal", maxStats: { alienCash: "x4.5", oof: "x20.5", blackholes: "x3", planets: "x4.75", runeSpeed: "x1.5" } },
            { name: "Orbit", maxLevel: 575, baseOdds: "700SxDe", type: "Normal", maxStats: { runeLuck: "x1.5", prism: "x1.05", knowledge: "x2", stars: "x101", oof: "x24" } },
            { name: "Cluster", maxLevel: 500, baseOdds: "17.5NoDe", type: "Normal", maxStats: { planets: "x3", alienXP: "x1.5", alienCash: "x1.9", moon: "x8", oof: "x26" } },
            { name: "Quasar", maxLevel: 400, baseOdds: "525QdVt", type: "Normal", maxStats: { tierLuck: "x6", blackholes: "x4", runeBulk: "x1.75", alienCash: "x2.5", stars: "x101", knowledge: "x2.5", oof: "x25" } },
            { name: "Pulsar", maxLevel: 300, baseOdds: "2.5e101", type: "Normal", maxStats: { blackholes: "x35", stars: "x6k", runeBulk: "x1.5", runeLuck: "x1.6", alienXP: "x5", oof: "x22", coin: "x151" } },
            { name: "Black Hole", maxLevel: 250, baseOdds: "1.0e103", type: "Normal", maxStats: { alienCash: "51", runeBulk: "x3.5", stars: "x12.5k", tierLuck: "x4", runeSpeed: "x1.75", planets: "x25", blackholes: "x12.5", oof: "x21" } },
            { name: "Magnetar", maxLevel: 475, baseOdds: "7.5TVt", type: "Noobinial", maxStats: { runeSpeed: "x5", oof: "x4.75k", stars: "x238k", alienCash: "x951", runeLuck: "x48.5", Planets: "x4.75k", alienXP: "x30", tierLuck: "x96" } },
            { name: "Event Horizon", maxLevel: 450, baseOdds: "50TVt", type: "Noobinial", maxStats: { runeBulk: "x4", blackholes: "x9k", prism: "x1.25", oof: "x9k", knowledge: "x226", alienCash: "x2.25k", tierLuck: "x136", tierBulk: "x41" } },
            { name: "Elemental Creation", maxLevel: 100, baseOdds: "200QnVt", type: "Noobinial", maxStats: { runeBulk: "x3", runeSpeed: "x2", oof: "x2.5k", alienCash: "x501", tierLuck: "x36", tierBulk: "x16", knowledge: "x101", blackholes: "x1k" } }
        ],
        "Light": [
    ...
    "Realm 5": {
        "Underwater": [
            { name: "Water", maxLevel: 250, baseOdds: 1.01, type: "Normal", maxStats: { bubbles: "x6" } },
            { name: "Bubbles", maxLevel: 250, baseOdds: "10B", type: "Normal", maxStats: { bubbles: "x9" } },
            { name: "Pond", maxLevel: 250, baseOdds: "10Qd", type: "Normal", maxStats: { air: "x6" } },
            { name: "Lake", maxLevel: 250, baseOdds: "10Sx", type: "Normal", maxStats: { coral: "x6" } },
            { name: "River", maxLevel: 250, baseOdds: "1No", type: "Normal", maxStats: { bubbles: "x16" } },
            { name: "Pool", maxLevel: 250, baseOdds: "10DDe", type: "Normal", maxStats: { air: "x11", coral: "x11" } },
            { name: "Sea", maxLevel: 250, baseOdds: "10SxDe", type: "Normal", maxStats: { bubbles:"x26" } },
            { name: "Ocean", maxLevel: 250, baseOdds: "100NoDe", type: "Normal", maxStats: { bubbles: "x101" } },
            { name: "Deep Sea", maxLevel: 250, baseOdds: "10UVt", type: "Normal", maxStats: { bubbles: "x251" } },
            { name: "Tidal Wave", maxLevel: "N/A", baseOdds: "10OcVt", type: "Noobinial", maxStats: { oof: "x111", bubbles: "x56", air: "x23", coral: "x23", yin: "x56", runeLuck: "x3.75", runeBulk: "x10", prism: "x1.02" } },
            { name: "Tsunami", maxLevel: "N/A", baseOdds: "10NoVt", type: "Noobinial" },
            { name: "Infinite Flood", maxLevel: "N/A", baseOdds: "1000NoVt", type: "Noobinial" }
        ],
        "Atlantis": [
            { name: "Underwater", maxLevel: 250, baseOdds: 1.01, type: "Normal" },
            { name: "Ancient City", maxLevel: 250, baseOdds: "10Qd", type: "Normal" },
            { name: "Mermaid", maxLevel: 250, baseOdds: "10Sx", type: "Normal" },
            { name: "Sea Monument", maxLevel: 250, baseOdds: "1No", type: "Normal" },
            { name: "Fish", maxLevel: 250, baseOdds: "10DDe", type: "Normal" },
            { name: "Coral", maxLevel: 250, baseOdds: "10SxDe", type: "Normal" },
            { name: "Sea shell", maxLevel: 250, baseOdds: "100NoDe", type: "Normal" },
            { name: "Pearl", maxLevel: 250, baseOdds: "1TVt", type: "Normal" },
            { name: "Natural Disaster", maxLevel: 250, baseOdds: "10SxVt", type: "Normal" },
            { name: "Secret of Atlantis", maxLevel: "N/A", baseOdds: "1NoVt", type: "Noobinial" },
            { name: "Poseidon", maxLevel: "N/A", baseOdds: "333NoVt", type: "Noobinial" },
            { name: "Lord of Atlantis", maxLevel: "N/A", baseOdds: "7.77Tg", type: "Noobinial" }
        ],
        "Aquatic Prism": [
...
function calculate() {
    ...
    itemsList.forEach(item => {
        ...
        const statLabels = {
            ...
            spacePoints: "Max Space Points",
            alienCash: "Max Alien Cash",
            alienXP: "Max Alien XP",
            yang: "Max Yang",
            yin: "Max Yin",
            ...
            coral: "Max Coral",
            oil: "Max Oil",
            trashCash: "Max Trash Cash",
            pearl: "Max Pearl",
            seaPoints: "Max Sea Points",
        };
